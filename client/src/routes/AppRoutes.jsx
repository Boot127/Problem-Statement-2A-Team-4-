...
// Work Permit routes (Developer 2) are fully implemented. The remaining
// feature routes render placeholder pages until their owning developer
// builds them out; all routes share the DashboardLayout shell (see App.jsx).
